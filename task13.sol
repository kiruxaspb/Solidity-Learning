...
1. public - функция доступна в контракте и вне его
2. private - функция доступна в исходном контракте и не доступна даже в унаследованных контрактах
3. internal - функция доступна только в этом контракте и в контрактах унаследования
4. external - функция доступна вне контракта внешними функциями и транзакциями

и 3 указателя для переменных:
1. public - похожа на internal, только доступна вне контракта
2. private - доступна только в контракте, не доступна даже в наследующих контрактах
3. internal - доступ к переменной есть только в контракте и наследующих его, доступа из вне нет
*/
